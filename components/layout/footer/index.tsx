...
const Footer = () => {
    ...
    return (
        <div>
            <div className="flex-col lg:flex-row flex gap-12 mx-[5%] mb-10 lg:mb-0">
                ...
                <div className="flex gap-4 w-full">
                    ...
                    <div>
                        <div className="mb-1 text-[18px] font-bold">
                            Bạn biết về một trường hợp cần giúp đỡ?
                        </div>
                        <div className="text-sm mb-5">
                            Hãy cho chúng tôi biết và chúng tôi sẽ thay mặt để liên hệ với người cần giúp đỡ.
                        </div>
