    ...
    return (
        <div className="relative inline-block text-left w-full max-w-[200px] h-[40px] cursor-pointer">
            ...
            <button
                ...
                className="w-full bg-white border border-gray-300 rounded-md shadow-sm px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 flex justify-between items-center"
            >
