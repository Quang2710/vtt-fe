        ...
        <div className="about-container flex flex-col items-center justify-center w-full h-full">
            ...
            <div className="about-page__intro-section w-full bg-white px-[14%] pt-[120px] pb-[80px] text-center">
                ...
                <div className="about-page__intro-section__row flex pt-[80px]">
                    ...
                    <div className="about-page__intro-section__row__col js-intro1 flex flex-col items-center justify-center w-1/3 px-[20px]">
                        <svg data-v-178dc0fa="" width="209" height="189" viewBox="0 0 209 189" fill="none" xmlns="http://www.w3.org/2000/svg" ><path data-v-178dc0fa="" d="M103.978 104.409C116.378 104.409 128.069 89.117 122.842 70.858C115.767 46.1383 88.7566 15.6651 57.7708 15.6651C26.7851 15.6651 15.7058 43.0605 15.7058 57.6316C15.7058 107.528 76.5236 153.654 103.978 173.3" stroke="url(#paint0_linear_755_593)" stroke-width="30" stroke-miterlimit="10" strokeLinecap="round"></path> <path data-v-178dc0fa="" d="M103.892 173.3C103.892 173.3 193.294 112.721 193.294 57.4456C193.294 27.3713 172.554 15 154.904 15C123.579 15 94.2492 41.5615 86.0751 72.0384C80.7827 91.7825 94.1937 104.32 103.892 104.32" stroke="url(#paint1_linear_755_593)" stroke-width="30" stroke-miterlimit="10" strokeLinecap="round"></path> <rect data-v-178dc0fa="" x="88" y="89" width="31" height="31" rx="15.5" fill="#ED078A"></rect> <defs data-v-178dc0fa=""><linearGradient data-v-178dc0fa="" id="paint0_linear_755_593" x1="133.949" y1="173.045" x2="133.949" y2="31.5692" gradientUnits="userSpaceOnUse"><stop data-v-178dc0fa="" stop-color="#EC008C"></stop> <stop data-v-178dc0fa="" offset="0.85" stop-color="#4B3299"></stop></linearGradient> <linearGradient data-v-178dc0fa="" id="paint1_linear_755_593" x1="96.4277" y1="24.3467" x2="96.4277" y2="176.869" gradientUnits="userSpaceOnUse"><stop data-v-178dc0fa="" stop-color="#F9ED32"></stop> <stop data-v-178dc0fa="" offset="0.7" stop-color="#EF4372"></stop> <stop data-v-178dc0fa="" offset="1" stop-color="#EC008C"></stop></linearGradient></defs></svg>
                    ...
                    <div className="about-page__intro-section__row__col js-intro1 flex flex-col items-center justify-center w-1/3 px-[20px]">
                        <svg data-v-178dc0fa="" width="206" height="172" viewBox="0 0 206 172" fill="none" xmlns="http://www.w3.org/2000/svg" ><line data-v-178dc0fa="" x1="15" y1="110.762" x2="15" y2="157" stroke="#4B3299" stroke-width="30" strokeLinecap="round"></line> <line data-v-178dc0fa="" x1="103.261" y1="87.5189" x2="103.261" y2="157" stroke="#00B49B" stroke-width="30" strokeLinecap="round"></line> <line data-v-178dc0fa="" x1="147.391" y1="38.2432" x2="147.391" y2="157" stroke="#D2D223" stroke-width="30" strokeLinecap="round"></line> <line data-v-178dc0fa="" x1="191" y1="15" x2="191" y2="157" stroke="url(#paint0_linear_755_589)" stroke-width="30" strokeLinecap="round"></line> <line data-v-178dc0fa="" x1="59.1304" y1="79.1514" x2="59.1304" y2="157" stroke="#2480C7" stroke-width="30" strokeLinecap="round"></line> <rect data-v-178dc0fa="" x="176" width="30" height="30" rx="15" fill="#FAFA32"></rect> <defs data-v-178dc0fa=""><linearGradient data-v-178dc0fa="" id="paint0_linear_755_589" x1="176" y1="197.5" x2="176" y2="29.5" gradientUnits="userSpaceOnUse"><stop data-v-178dc0fa="" stop-color="#EA0A87"></stop> <stop data-v-178dc0fa="" offset="1" stop-color="#FACC37"></stop></linearGradient></defs></svg>
                ...
                <div className="flex flex-wrap justify-center gap-12 pt-[50px] pb-[100px]">
                    {[
                        ...
                        <div key={idx} className="flex flex-col items-center w-[220px]">
                            ...
                            <div className="text-[16px] text-[#666]">{member.title}</div>
                        </div>
                    ))}
                </div>
