    ...
    <div className="blog-container w-full bg-gray-100">
      <div className="campaign-page__container mx-[10%] p-[20px] flex flex-col gap-4 sm:flex-row sm:flex-nowrap ">
        <div className="campaign-container w-full max-w-full sm:w-[68%]">
          ...
          <h1 className="text-2xl font-medium mb-2 p-[10px] my-[20px]">
            [Urgent] Baby Hana Needs a Liver Transplant by August 2025 to
            Survive
          </h1>
          ...
          <div className="flex items-center justify-between w-full px-[25px] py-[18px] rounded-[10px] bg-white mt-[20px]">
            ...
            <div className="upsell-content flex-1 px-4">
              <h3 className="text-[18px] font-medium text-[#666]">
                We believe <b>every child deserves a chance</b> to live beyond
                ...
                <div className="bg-white rounded-[10px] p-4">
                  <Slider {...settings}>
                    {tabList.map((t) => (
                      <button
                        key={t.key}
                        className={`cursor-pointer px-4 py-2 font-medium text-[15px] border-b-2 transition-colors duration-150 ${
                          tab === t.key
        ...
        <div className="campaign-side w-full max-w-full sm:w-[31%] sm:mt-0">
          <div className="w-full bg-white rounded-[10px] shadow p-[20px] ">
            ...
            <div className="w-full h-3 bg-gray-200 rounded-full mt-4 mb-2 overflow-hidden">
              <div
                className="h-full bg-gradient-to-l from-[#EDA774] to-[#EB008C] rounded-full"
                style={{ width: "70%" }}
              ></div>
            </div>
            <p className="text-[14px] font-normal text-[#999] leading-[20px] mt-2">
            ...
            <div className="trending flex items-center rounded-[30px] my-4 border border-[#a0d8bd] bg-[#e5fff3] p-2 box-border">
              ...
              <span className="text-[14px] font-medium text-[#026d3a] flex flex-col justify-start w-[70%]">
                <p className="flex gap-2 justify-start items-center">
                  <FaArrowTrendUp />
                  Trending
                </p>
                <span>943 givers in the past week</span>
              </span>
            </div>

            <div className="py-[15px] border-b border-[#eee]">
              <span className="text-[14px] font-normal leading-[20px] text-[#666]">
                Donations will go to <b>HANA CHIN ZI YING</b> via{" "}
                <b>GIVE Healthcare</b>
              </span>
            </div>
          ...
          <Link href={"/trust-and-safety"}>
            <div className="trust-and-safety trust-and-safety--campaign bg-[#4b3299] p-[16px] rounded-[10px] mt-[20px] cursor-pointer">
              ...
              <div className="flex flex-col">
                <div className="text-[14px] text-white rounded-[8px] border border-white/15 p-4 my-2 flex items-center gap-4">
                  <span className="min-w-[40px] min-h-[40px] w-10 h-10 grid place-items-center rounded-full bg-white">
                    <LiaUserShieldSolid className="text-[24px] text-[#4b3299]" />
                  </span>
                ...
                <div className="text-[14px] text-white rounded-[8px] border border-white/15 p-4 my-2 flex items-center gap-4">
                  <span className="min-w-[40px] min-h-[40px] w-10 h-10 grid place-items-center rounded-full bg-white">
                    <LuUserSearch className="text-[24px] text-[#4b3299]" />
                  </span>
                  This campaign was verified on 15.07.2025
                </div>
                <div className="text-[14px] text-white rounded-[8px] border border-white/15 p-4 my-2 flex items-center gap-4">
                  <span className="min-w-[40px] min-h-[40px] w-10 h-10 grid place-items-center rounded-full bg-white">
                    <PiAmbulanceBold className="text-[24px] text-[#4b3299]" />
                  </span>
                ...
                <div className="text-[14px] text-white rounded-[8px] border border-white/15 p-4 my-2 flex items-center gap-4">
                  <span className="min-w-[40px] min-h-[40px] w-10 h-10 grid place-items-center rounded-full bg-white">
                    <TbShieldLock className="text-[24px] text-[#4b3299]" />
                  </span>
                  All donations go directly to the hospital or nonprofit
                  organisation
                </div>
          ...
          <div className="campaign-cta-testimonials bg-white p-[16px] rounded-[10px] mt-[20px]">
            <h3 className="text-[20px] font-semibold text-[#333] mb-4">
              Testimonials
            </h3>
            <div className="testimonial-item bg-white py-3 rounded-[10px] mb-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[14px] text-gray-700 mt-1">
                  "This campaign has changed our lives. Thank you for your
                  support!"
                </p>
              </div>
            </div>
          ...
          <div className="campaign-cta-donors bg-white p-[16px] rounded-[10px] mt-[20px]">
            ...
            <div className="text-[14px] text-[#666] font-semibold text-center mt-2">
              <b>+ 2092 givers</b> have donated to this campaign
            </div>
          </div>
          ...
          <div className="campaign-extra-details__section bg-white p-[16px] rounded-[10px] mt-[20px]">
            <div className="flex flex-col items-start">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[14px] font-bold text-[#74ae3b]">
                  Verified by
                </span>
                <span className="text-[14px] font-bold text-[#eb008c]">
                  GIVE Healthcare
                </span>
              </div>
              <div className="text-[14px] text-[#666]">
                Our verification process involves contacting and meeting the
                fundraiser as well as the beneficiary, reviewing financial,
                medical, and other applicable documents that offer evidence of
                the need.
